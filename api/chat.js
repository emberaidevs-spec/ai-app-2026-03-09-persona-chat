export default async function handler(req, res) {
  try {
    ...
    if (!req.body || !req.body.persona || !req.body.conversationHistory || !req.body.userInput) {
    ...
    const { persona, conversationHistory, userInput } = req.body;

    const systemPrompt = `You are ${persona}. You will respond to the user's input based on your persona. Be helpful and provide personalized advice. Do not provide any harmful or offensive content.`;
